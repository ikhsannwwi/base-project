                            ...
                            <div class="section">
                                <div class="py-5">
                                    <div class="rounded border p-10">
                                        <form action="{{route('admin.menus.store')}}" method="post" enctype="multipart/form-data" id="form"
                                                ...
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <div class="input-group">
                                                            <input data-placement="bottomRight" class="form-control icp-auto" name="icon" value="" type="text" autocomplete="off" data-parsley-required="true"/>
