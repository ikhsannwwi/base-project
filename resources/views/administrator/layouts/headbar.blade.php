    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
        ...
        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
            ...
            <a href="index.html" class="d-flex align-items-center">
                <img alt="Logo" src="{{ template_administrator('assets/media/logos/logo-compact.svg') }}"
                    class="max-h-40px" />
            </a>
            <!--end::Logo-->
        </div>
        ...
        <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="scroll-y mh-200px mh-lg-325px">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ template_administrator('assets/media/avatars/150-1.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ template_administrator('assets/media/avatars/150-3.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ template_administrator('assets/media/avatars/150-8.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ template_administrator('assets/media/avatars/150-11.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ template_administrator('assets/media/avatars/150-12.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ template_administrator('assets/media/svg/brand-logos/volicity-9.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ template_administrator('assets/media/svg/brand-logos/tvit.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ template_administrator('assets/media/svg/brand-logos/tower.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
            ...
            <div class="d-flex align-items-center ms-1 ms-lg-3">
                ...
                <div class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px"
                    ...
                    data-bs-html="true" data-bs-placement="bottom" id="kt_drawer_chat_toggle">
                    <!--begin::Svg Icon | path: icons/duotone/Communication/Group-chat.svg-->
                    <span class="svg-icon svg-icon-1">
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="pt-10 pb-0">
                                    ...
                                    <div class="text-center text-gray-600 fw-bold pt-1">Outlines keep
                                        you honest. They stoping you from amazing poorly about drive
                                    </div>
                                    <!--end::Text-->
                                    <!--begin::Action-->
                                    <div class="text-center mt-5 mb-9">
                                        <a href="#" class="btn btn-sm btn-primary px-6"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Join
                                            Now</a>
                                    </div>
                                    <!--end::Action-->
                                </div>
                                ...
                                <div class="text-center mb-5 px-4">
                                    <img class="mw-100 mh-175px" alt=""
                                        src="{{ template_administrator('assets/media/illustrations/verification.png') }}" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Wrapper-->
            ...
            <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                    ...
                    <img src="{{img_src(auth()->user() ? auth()->user()->image : '','accounts')}}" alt="metronic" />
                </div>
                <!--begin::Menu-->
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo"
                                    src="{{img_src(auth()->user() ? auth()->user()->image : '','accounts')}}" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                                ...
                                <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{auth()->user() ? auth()->user()->email : ''}}</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('admin.account', auth()->user() ? auth()->user()->uuid : '')}}" class="menu-link px-5">Profile</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                    ...
                    <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start"
                        ...
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="apps/subscriptions/view.html"
                            ...
                            <span class="menu-title position-relative">Language
                                <span
                                    ...
                                    <img class="w-15px h-15px rounded-1 ms-2"
                                        src="{{ template_administrator('assets/media/flags/united-states.svg') }}"
                        ...
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ template_administrator('assets/media/flags/spain.svg') }}"
                                            alt="metronic" />
                                    </span>Spanish</a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ template_administrator('assets/media/flags/germany.svg') }}"
                                            alt="metronic" />
                                    </span>German</a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ template_administrator('assets/media/flags/japan.svg') }}"
                                            alt="metronic" />
                                    </span>Japanese</a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ template_administrator('assets/media/flags/france.svg') }}"
                                            alt="metronic" />
                                    </span>French</a>
                            </div>
                            <!--end::Menu item-->
                    ...
                    <div class="menu-item px-5 my-1">
                        <a href="{{route('admin.account.settings', auth()->user() ? auth()->user()->uuid : '')}}" class="menu-link px-5">Account Settings</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
