                            ...
                            <div class="section">
                                <div class="py-5">
                                    <div class="rounded border p-10">
                                        <form action="{{route('admin.module_managements.store')}}" method="post" enctype="multipart/form-data" id="form"
                                                ...
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <div class="input-group">
                                                            <input data-placement="bottomRight" id="input_icon" class="form-control icp-auto" name="icon" value="" type="text" autocomplete="off" data-parsley-required="true"/>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <input type="text" name="identifier" class="form-control" placeholder="identifier" autocomplete="off"
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <input type="text" name="url" class="form-control" placeholder="Url" autocomplete="off"
                                                            data-parsley-required="true"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-10">
                                                <div class="col-12">
                                                    ...
                                                    <div id="module_access">
                                                        <div class="row list-access" childidx="0">
                                                            <div class="col-4 col-sm-5 col-md-5 col-lg-5 col-xl-5 col-xxl-5">
                                                                <div class="form-group mandatory mb-10">
                                                                    <label class="form-label">Type</label>
                                                                    <select class="form-select form-select-solid type-item" data-control="select2" name="module_access[0][type]" data-placeholder="Select an option" data-allow-clear="true" data-hide-search="true" data-parsley-required="true">
                                                                        <option value=""></option>
                                                            ...
                                                            <div class="col-7 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                                <div class="form-group mandatory access-code-select mb-10" style="display: none">
                                                                    <label class="form-label">Access Code</label>
                                                                    <select class="form-select form-select-solid module_access-code-select" data-control="select2" name="module_access[0][code]" data-placeholder="Select an option" data-allow-clear="true" data-hide-search="true">
                                                                        <option value=""></option>
                                                                ...
                                                                <div class="form-group mandatory access-code-input mb-10" style="display: none">
                                                                    <label class="form-label">Access Code</label>
                                                                    <input type="text" name="module_access[0][code]" class="form-control module_access-code-input" placeholder="Other Access Code" autocomplete="off"
                                                                        data-parsley-required="true"/>
                                                                </div>
                                                            </div>
        ...
        <div class="row access-list" childidx="0">
            ...
            <div class="col-7 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <div class="form-group mandatory access-code-select mb-10">
                    <label class="form-label">Access Code</label>
                    <select class="form-select form-select-solid module_access-code-select" name="module_access[0][code]" data-placeholder="Select an option" data-allow-clear="true" data-hide-search="true">
                        <option value=""></option>
                        <option value="view">View</option>
                        <option value="add">Add</option>
                        <option value="edit">edit</option>
            ...
            <div class="col-1 p-0">
                <div class="form-group mb-10 pt-9">
                    <a href="javascript:void(0)" class="btn btn-light-danger btn-sm removeData"><i class="fas fa-trash"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            $("#module_access").on("click", ".removeData", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // $.ajax({
                        //     url: '/admin/setting/deleteContentContactUs',
                        //     data: {
                        //         id: id,
                        //     },
                        //     type: "get",
