                            ...
                            <div class="section">
                                <div class="py-5">
                                    <div class="rounded border p-10">
                                        <form action="{{route('admin.user_groups.update')}}" method="post" enctype="multipart/form-data" id="form"
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <input type="text" name="name" value="{{$data->name}}" class="form-control" placeholder="Name" autocomplete="off" id="inputName"
                                                                        ...
                                                                        <td>
                                                                            @foreach ($module->access as $row)
                                                                                <span class="akses mx-1">
                                                                                    <label>
                                                                                        <div class="form-check form-check-custom form-check-solid">
                                                                                            <input type="checkbox" name="access[{{ $index }}][module_access][{{ $row->id }}]" class="form-check-input access_{{$index}}" id="access_{{$index}}_module_access_{{ $row->id }}" value="1" {{ $permission[$data->id][$module->identifier][$row->identifier] == 1 ? 'checked' : ''}}><label for="access_{{$index}}_module_access_{{ $row->id }}" class="form-check-label">{{ $row->name }}</label>
                                                                                        </div>
                                                                                    </label>
                                                                                </span>
                                                                            @endforeach
