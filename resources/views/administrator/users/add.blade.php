                                    ...
                                    <div class="rounded border p-10">
                                        <form action="{{route('admin.users.store')}}" method="post" enctype="multipart/form-data" id="form"
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9 col-xxl-9">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <input type="text" name="name" class="form-control" placeholder="ex : Qwerty" autocomplete="off"
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <input type="text" name="email" class="form-control" placeholder="ex : qwerty@gmail.com" autocomplete="off"
                                                ...
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <input type="text" name="telephone" class="form-control" placeholder="ex : 08xxxxxxxxxx" autocomplete="off"
                                                            data-parsley-required="true" data-parsley-type="number" data-parsley-telephone-registered data-parsley-length="[11, 13]"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group mandatory mb-10">
                                                        ...
                                                        <input type="text" name="password_confirmation" class="form-control" placeholder="ex : qwerty123" autocomplete="off"
                                                            data-parsley-required="true" data-parsley-minlength="8" data-parsley-equalto="#passwordField"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-end">
                                                ...
                                                <button type="submit" class="btn btn-light-primary btn-sm mx-1 me-10"
                                                    id="btn_form_submit">
